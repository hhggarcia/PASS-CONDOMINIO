...
namespace Prueba.Controllers
{
    ...
    public class CondominiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCondominio,IdAdministrador,Rif,Tipo,Nombre")] Condominio condominio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCondominio,IdAdministrador,Rif,Tipo,Nombre")] Condominio condominio)
        {
        ...
        {
            return (_context.Condominios?.Any(e => e.IdCondominio == id)).GetValueOrDefault();
        }
    }
}
