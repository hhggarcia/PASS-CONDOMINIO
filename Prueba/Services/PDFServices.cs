                    ...
                    foreach (var item in reciboCobroVM)
                    {
                     ...
                     .Column(x =>
                     {
                         ...
                         x.Item().Column(x =>
                         {
                             ...
                             x.Item().AlignRight().Text("Indexación =>" + item.propiedad.MontoMulta?.ToString("N"));
                             x.Item().AlignRight().Text("Total Cuota del Mes =>" + (totalGastosGenerales + totalGastosIndividuales + item.propiedad.MontoIntereses+ item.propiedad.MontoMulta).ToString("N"));
                             x.Item().AlignRight().Text("Saldo Ant. Cuotas Ord. =>" + item.propiedad.Saldo.ToString("N"));
                             x.Item().AlignRight().Text("Saldo Ant. Cuotas Extras =>" + item.propiedad.MontoMulta?.ToString("N"));
                             x.Item().AlignRight().Text("Acumulado =>" + item.propiedad.MontoMulta?.ToString("N"));
                         });
                     });
                        page.Footer()
                            .AlignLeft()
