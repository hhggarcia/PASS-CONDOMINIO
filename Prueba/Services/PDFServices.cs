...
namespace Prueba.Services
{
    ...
    public class PDFServices: IPDFServices
    {
        ...
        public byte[] RetencionesIva(ListaRetencionesIVAVM listaRetencionesIVAVM)
        {
            var data = Document.Create(container =>
            {
                container.Page(page =>
                    ...
                    page.Content()
                        ...
                        .Column(x =>
                        {
                            ...
                            x.Item().Border(0.5f).BorderColor("#D9D9D9").Table(tabla =>
                            {
                                ...
                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                                 .Padding(5).Text(listaRetencionesIVAVM.Comprobante).FontColor("#607080").Bold().FontSize(10);

                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text(listaRetencionesIVAVM.Fecha).FontColor("#607080").Bold().FontSize(10);

                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text(listaRetencionesIVAVM.Proveedor).FontColor("#607080").Bold().FontSize(10);
                               ...
                               .Padding(5).Text("").FontColor("Total general =>").Bold().FontSize(10);
                                ...
                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text("").FontColor("Fecha").Bold().FontSize(10);
                                
                                
                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text("Fecha").Underline().FontColor("#607080").Bold().FontSize(10);

                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text("Factura").Underline().FontColor("#607080").Bold().FontSize(10);
                               ...
                               .Padding(5).Text("I.V.A.").FontColor("Fecha").Bold().FontSize(10);   
                                ...
                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text("% Retenciones").Underline().FontColor("Fecha").Bold().FontSize(10);  
                               ...
                               .Padding(5).Text("").Underline().FontColor("#607080").Bold().FontSize(10);
                                ...
                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text("").Underline().FontColor("Total general =>").Bold().FontSize(10);
                                       
                                tabla.Cell().Border(0.5f).BorderColor("#D9D9D9").AlignMiddle()
                               .Padding(5).Text("Total General =>").FontColor("Fecha").Bold().FontSize(10);   
        ...
        public byte[] ComprobanteRetencionesIVA()
        {
            var data = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Content()
                        ...
                        .Column(x =>
                        {
                            x.Item().AlignRight().Text("COMPROBANTE DE RETENCIÓN DEL IMPUESTO AL VALOR AGREGADO").Bold().FontSize(18).FontColor("#004581");
                            ...
                            x.Item().Row(x =>
                            {
                                x.RelativeItem().Text("TOTAL COMPRAS MENOS I.V.A. RETENIDO =>");
                                x.RelativeItem().Text("");
                            });   
        ...
        public byte[] ComprobanteRetencionesISLR()
        {
            var data = Document.Create(container =>
            {
                container.Page(page =>
            ...
            var data = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Content()
                        ...
                        .Column(x =>
                        {
                            x.Item().AlignRight().Text("Libro de Ventas I.V.A").Bold().FontSize(18).FontColor("#004581");
