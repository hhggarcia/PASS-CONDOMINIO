...
namespace Prueba.Migrations
{
    public partial class SeedRoles : Migration
    {
        ...
        private void SeedRolesSQL(MigrationBuilder migrationBuilder)
        {
            ...
            VALUES ('{AdminRoleId}', 'SuperAdmin', 'SUPERADMIN', null);");
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{ManagerRoleId}', 'Administrador', 'ADMINISTRADOR', null);");
            migrationBuilder.Sql(@$"INSERT INTO [dbo].[AspNetRoles] ([Id],[Name],[NormalizedName],[ConcurrencyStamp])
            VALUES ('{UserRoleId}', 'Propietario', 'PROPIETARIO', null);");
        }
...
VALUES 
(N'{User2Id}', N'Test 2', N'Lastname', N'test2@test.ca', N'TEST2@TEST.CA', 
...
[PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) 
VALUES 
(N'{User3Id}', N'Test 3', N'Lastname', N'test3@test.ca', N'TEST3@TEST.CA', 
