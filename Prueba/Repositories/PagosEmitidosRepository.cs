            ...
            if (modelo.Pagoforma == FormaPago.Efectivo)
            {
                try
                {
                    ...
                    if (modelo.retencionesIva && !modelo.retencionesIslr)
                    {
                        ...
                        var stringNumRetFecha = DateTime.Today.Year.ToString() + DateTime.Today.ToString("MM");
                        ...
                        var comp = new CompRetIva
                        {
                            ...
                            NumCompRet = DateTime.Today.Year.ToString() + "-" + DateTime.Today.ToString("MM") + "-" + ceros + numRet.ToString(),
                    ...
                    else if (modelo.retencionesIva && modelo.retencionesIslr)
                    {
                        ...
                        if (islr != null)
                        {
                            ...
                            var stringNumRetFechaIslr = DateTime.Today.Year.ToString() + DateTime.Today.ToString("MM");
                            ...
                            var compIslr = new ComprobanteRetencion
                            {
                                ...
                                ValorRetencion = itemLibroCompra.RetIslr,
                                TotalImpuesto = itemLibroCompra.RetIslr,
                                NumCompRet = DateTime.Today.Year.ToString() + "-" + DateTime.Today.ToString("MM") + "-" + cerosIslr + numRetIslr.ToString(),
