...
//ingresos
var ingresoEnero = $("#ingreso1").val();
var ingresoFebrero = $("#ingreso2").val();
var ingresoMarzo = $("#ingreso3").val();
var ingresoAbril = $("#ingreso4").val();
var ingresoMayo = $("#ingreso5").val();
var ingresoJunio = $("#ingreso6").val();
var ingresoJulio = $("#ingreso7").val();
var ingresoAgosto = $("#ingreso8").val();
var ingresoSeptiembre = $("#ingreso9").val();
...
var eAbril = $("#egreso4").val();
var eMayo = $("#egreso5").val();
var eJunio = $("#egreso6").val();
var eJulio = $("#egreso7").val();
var eAgosto = $("#egreso8").val();
var eSeptiembre = $("#egreso9").val();
var eOctubre = $("#egreso10").val();
var eNoviembre = $("#egreso11").val();
var eDiciembre = $("#egreso12").val();
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
    labels: ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ag", "Sep", "Oct", "Nov", "Dic"],
